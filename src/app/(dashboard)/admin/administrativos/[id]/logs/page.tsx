// src/app/(dashboard)/administrativo/logs/page.tsx
"use client";
...
export default function LogsAdministrativoPage() {
  ...
  const cargarLogs = async () => {
    try {
      ...
      // 🔐 Ruta para logs del administrativo actual (basado en sesión)
      const response = await fetch(`/api/administrativo/logs?${params_url}`);
  ...
  const exportarLogs = (formato: "csv" | "json") => {
    if (formato === "csv") {
      ...
      link.href = url;
      link.download = `logs-administrativo-${new Date()
        .toISOString()
        .split("T")[0]}.csv`;
      link.click();
        ...
        <div className="text-center relative">
          ...
          <div className="relative z-10">
            ...
            <p className={`${textSecondary} font-medium animate-pulse`}>
              Analizando historial de tu cuenta administrativa...
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto space-y-6 relative z-10">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <RechartsPieChart>
                    <Pie
                      ...
                      labelLine={false}
                      label={({ payload }) => {
                        const data = payload as { nombre: string; cantidad: number };
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className={`text-sm ${textSecondary}`}>
                Refina tu historial por módulo, acción, severidad, fecha y más.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div className="lg:col-span-2">
              <div className="relative group">
                ...
                <input
                  type="text"
                  placeholder="Buscar en tus logs..."
                        ...
                        return (
                          <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                              ...
                              >
                                <p
                                  className={`text-xs font-black uppercase ${textMuted} mb-2`}
                                >
                                  ID Log
                                </p>
                                <p
                                  className={`font-mono font-bold ${textPrimary}`}
                                >
                                  #{log.id_log}
                                </p>
                              </div>
                              ...
                              >
                                ...
                                <p
                                  className={`font-mono text-sm ${textSecondary} truncate`}
                                >
                                  {log.user_agent}
                                </p>
                              </div>
                              ...
                              >
                                ...
                                <p
                                  className={`font-mono text-sm ${textSecondary}`}
                                >
                            ...
                            >
                              <div className="flex items-center justify-between mb-4">
                                <h4
                                  className={`font-black text-lg ${textPrimary}`}
                                >
                                  Detalles JSON
                                </h4>
                                <button
                            ...
                            >
                              <h4
                                className={`font-black text-lg ${textPrimary} mb-4`}
                              >
                                Análisis de Seguridad
                              </h4>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-wrap justify-center">
                    ...
                    <div className="flex items-center gap-1">
                      {Array.from(
                        {
                          length: Math.min(5, paginacion.total_pages),
                        },
                        (_, i) => {
                          const pageNum =
                            paginacion.page <= 3
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className={`text-sm mt-2 ${textSecondary}`}>Escala 1-5</p>
                </div>
              </div>
            </div>
                ...
                {logStats?.user_agents.slice(0, 10).map((ua, idx) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => copiarAlPortapapeles(ua.user_agent)}
                          className={`p-2 rounded-lg transition-all duration-300 ${
                            darkMode
                              ? "bg-slate-800 hover:bg-slate-700"
                              : "bg-white hover:bg-slate-100"
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <p className={`text-sm ${textSecondary}`}>
                        Monitorea con mayor frecuencia el módulo{" "}
                        <strong>
                          {logStats?.modulos_mas_activos[0]?.modulo}
                        </strong>{" "}
                        para detectar anomalías en tus procesos administrativos.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <p className={`text-sm ${textSecondary}`}>
                        Revisa eventos de severidad alta (4-5) para prevenir
                        errores en agendamiento, registros o reportes.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <p className={`text-sm ${textSecondary}`}>
                        Mantén buenas prácticas de acceso: sesión cerrada cuando
                        no uses el sistema y credenciales actualizadas.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <p
                className={`text-xs font-black uppercase tracking-wider ${textMuted} mb-2`}
              >
                Información
              </p>
              <p className={`${textSecondary} text-sm`}>
                Perfil:{" "}
                <span className="font-mono font-bold">ADMINISTRATIVO</span>
              </p>
