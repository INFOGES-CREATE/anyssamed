// frontend/src/app/(dashboard)/admin/administrativos/nuevo/page.tsx
"use client";
...
export default function NuevoAdministrativoPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    estado: "activo" as "activo" | "inactivo" | "suspendido" | "vacaciones",
    jornada: "completa" as "completa" | "media" | "parcial",
    cargo: "",
    nivel_acceso: "basico" as
      | "basico"
      | "intermedio"
      | "avanzado"
      | "administrador",
  ...
  const cargarCatalogos = async () => {
    try {
      ...
      console.log("🌍 Cargando catálogos para administrativos...");
      ...
      // 6️⃣ Supervisores (administrativos jefes)
      try {
  ...
  // ==============================
  // 🏢 SUCURSALES + DEPT/SUPERVISORES POR CENTRO
  // ==============================
  useEffect(() => {
  ...
  useEffect(() => {
    if (formData.password) {
      ...
      if (!/[^A-Za-z0-9]/.test(formData.password))
        requisitos.push("carácter especial");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.roles.length === 0) {
        setError("Debe seleccionar al menos un rol (incluyendo el de administrativo)");
        setLoading(false);
        return;
      }
      ...
      if (!formData.cargo) {
        setError("Debe indicar el cargo del administrativo");
        setLoading(false);
        return;
      }

      if (!formData.fecha_inicio) {
        setError("Debe indicar la fecha de inicio del administrativo");
        setLoading(false);
        return;
      }
      ...
      const bodyToSend = {
        ...
        // ADMINISTRATIVO (mapea directo a la tabla `administrativos`)
      ...
      const response = await fetch("/api/admin/administrativos/nuevo", {
        method: "POST",
      ...
      if (data.success) {
        setSuccess(true);
        setTimeout(() => {
          router.push("/admin/administrativos");
        }, 2000);
      } else {
        setError(data.error || "Error al crear administrativo");
      }
    } catch (error) {
      ...
      >
        ...
        <div className="text-center relative z-10">
          ...
          <h3 className={`text-2xl font-black ${textPrimary} mb-2`}>
            ...
            Cargando Formulario de Administrativo
          </h3>
    ...
    >
      ...
      <div className="max-w-6xl mx-auto space-y-6 relative z-10">
        ...
        {success && (
          ...
          >
            ...
            <div className="flex-1">
              ...
              >
                ¡Administrativo creado exitosamente!
              </h3>
              ...
              >
                Redirigiendo al panel de administrativos...
              </p>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <label className="flex items-center gap-3 cursor-pointer group">
                  ...
                  >
                    Enviar email de bienvenida al administrativo
                  </span>
                </label>
              </div>
            </div>
          ...
          {/* DATOS LABORALES ADMINISTRATIVO */}
          <div
            className={`${cardBg} rounded-3xl shadow-2xl border ${borderColor} p-6 animate-in fade-in slide-in-from-bottom-4 duration-500 overflow-hidden relative`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Coordinador SOME, Administrativo RRHH, etc."
                  />
                </div>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className={`text-sm ${textMuted} mt-1`}>
                    Asigna los roles adecuados para el administrativo *
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  >
                    {!formData.id_pais
                      ...
                      : "Debe crear roles en el sistema antes de crear administrativos"}
                  </p>
                </div>
              ) : (
                <>
                  ...
                  {formData.roles.length === 0 && (
                    ...
                    >
                      ...
                      >
                        ...
                        Debe seleccionar al menos un rol para el administrativo
                      </p>
                    </div>
                  )}
                </>
                  ...
                  <div className="mt-4 flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <p className={`text-sm ${textMuted}`}>
                        La imagen se mostrará en el perfil del administrativo en
                        todas las vistas.
                      </p>
                    </div>
                  </div>
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className={`text-2xl font-black ${textPrimary} mb-6`}>
                📋 Resumen de Datos del Administrativo
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className={`text-lg font-black ${textPrimary} truncate`}>
                    {centrosFiltrados.find(
                      (c) =>
                        c.id_centro ===
                        parseInt(formData.id_centro_principal || "0")
                    )?.nombre || "No especificado"}
                  </p>
                </div>
                ...
                >
                  ...
                  <p className={`text-lg font-black ${textPrimary}`}>
                    {formData.estado} / {formData.jornada}
                  </p>
                </div>
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  >
                    Contraseña:{" "}
                    {validaciones.password.valido ? "✓ Segura" : "✗ Débil"}
                  </span>
                </div>
                ...
                >
                  ...
                  >
                    Roles:{" "}
                    {formData.roles.length > 0 ? "✓ Asignados" : "✗ Requerido"}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-2">
                {loading ? (
                  <>
                    ...
                    <span>Creando administrativo...</span>
                  </>
                ) : (
                  <>
                    <Save className="w-5 h-5" />
                    <span>Crear Administrativo</span>
                  </>
                )}
              </div>
            </button>
