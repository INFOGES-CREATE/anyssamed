...
interface UsuarioSesion {
  ...
  // centro asignado genérico para cualquier usuario
  centro_principal?: CentroPrincipal;
  // datos especiales si el usuario es médico
  medico?: {
...
export default function PerfilUsuarioPage() {
  ...
  const centroPrincipal: CentroPrincipal | null =
    usuario?.medico?.centro_principal || usuario?.centro_principal || null;
  ...
  if (usuario?.rol?.nombre) {
    const rolNorm = usuario.rol.nombre
      ...
      .replace(/[\u0300-\u036f]/g, "")
      .toUpperCase();
    if (rolNorm.includes("MEDICO")) basePath = "/medico";
    else if (rolNorm.includes("SECRETARIA")) basePath = "/secretaria";
              ...
              <div key={idx} className="mb-1">
                ...
                >
                  ...
                  >
                    ...
                    {sidebarAbierto && (item as any).submenu && (
                      <ChevronDown
                  ...
                  {sidebarAbierto && (item as any).submenu && menuExpandido === item.titulo && (
                    <div className="mt-2 ml-4 space-y-1">
                      {(item as any).submenu.map((sub: any, i: number) => (
                        <Link
                          key={i}
                          href={sub.url}
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
            ...
            <p className={tema.colores.textoSecundario}>
              Administra tu identidad, datos de cuenta y el comportamiento de tu panel.
            </p>
          </div>
          ...
          {cargandoMetricas ? (
            ...
            <>
              ...
              <Estadistica
                ...
                secondary="Incluye agenda general"
                tema={tema}
              />
              <Estadistica
                icon={Star}
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <div className="flex-1">
                  <p className={`text-sm ${tema.colores.textoSecundario} mb-2`}>
                    Se mostrará en panel, módulos, videollamadas y auditoría.
                  </p>
            ...
            >
              ...
              <div className="space-y-3 mb-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className={tema.colores.texto}>Credenciales profesionales</p>
                    <p className={`text-xs ${tema.colores.textoSecundario}`}>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className={tema.colores.textoSecundario}>
                      Se muestra a tu organización y, si aplica, a pacientes o usuarios.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className={tema.colores.textoSecundario}>
                      Esto puede mostrarse en tu ficha interna o para pacientes.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Ej: Profesional de la salud con enfoque en atención primaria..."
                    ></textarea>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className={tema.colores.textoSecundario}>
                      Conecta tus calendarios y videollamadas.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={tema.colores.textoSecundario}>Perfil del usuario</p>
                  </div>
                </div>
