...
interface ExamenMedico {
  ...
  id_paciente: number;
  id_tipo_examen: number;
  id_profesional_solicitante: number;
  id_centro: number;
  ...
  const cargarDatosExamenes = async () => {
    ...
    try {
      ...
      const params = new URLSearchParams({
        id_profesional: usuario.medico.id_profesional.toString(),
    ...
    for (let i = 0; i < 10; i++) {
      ...
      for (let j = 0; j < cantidadExamenes; j++) {
        ...
        const examen: ExamenMedico = {
          ...
          id_profesional_solicitante: usuario?.medico?.id_profesional || 1,
          id_centro: usuario?.medico?.centro_principal.id_centro || 1,
      ...
      const orden: OrdenExamen = {
        ...
        id_centro: usuario?.medico?.centro_principal.id_centro || 1,
        id_paciente: paciente.id,
        id_profesional: usuario?.medico?.id_profesional || 1,
        numero_orden: generarNumeroOrden(),
