    ...
    const cargarPreferenciaTema = async () => {
      try {
        ...
        if (data.success && data.tema_color && TEMAS[data.tema_color as TemaColor]) {
          ...
          const temaLocal = localStorage.getItem("tema_secretaria") as TemaColor | null;
              ...
              <div className="space-y-4 mt-2">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <select
                    ...
                    onChange={(e) => handleCambioIdioma(e.target.value as IdiomaUI)}
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <select
                    ...
                    className={`px-3 py-2 rounded-xl text-sm font-semibold ${tema.colores.card} ${tema.colores.borde} border ${tema.colores.texto}`}
                  >
                    <option value="America/Santiago">America/Santiago (CESFAM)</option>
            ...
            >
              ...
              <div className="space-y-4 mt-2">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    {(["pequeno", "normal", "grande", "muy_grande"] as TamanoFuente[]).map(
                      (t) => (
                        <button
                          key={t}
                          type="button"
              ...
              <div className="space-y-4 mt-2">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className={`text-xs ${tema.colores.textoSecundario}`}>
                      Enviar recordatorios automáticos por WhatsApp (si está disponible).
                    </p>
                  </div>
                  <div
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="space-y-3 mt-3">
                {/* Aquí puedes reemplazar por datos reales de /api/auth/sessions */}
                <div
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className={`text-xs font-semibold ${tema.colores.texto}`}>
                        Equipo actual · Curicó
                      </p>
                      <p className={`text-[11px] ${tema.colores.textoSecundario}`}>
                        Chrome en Windows · {new Date().toLocaleString("es-CL")}
                      </p>
                    </div>
                  </div>
                ...
                <div
                  className={`rounded-xl p-3 ${tema.colores.card} ${tema.colores.borde} border flex items-center justify-between gap-3 opacity-70`}
                >
                  <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`mt-4 w-full flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-xs font-bold border ${tema.colores.card} ${tema.colores.borde} ${tema.colores.texto} hover:${tema.colores.hover}`}
              >
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              >
                Personaliza tu experiencia sin afectar la configuración global del
                establecimiento.
              </p>
            </div>
            ...
            <div className="flex flex-col items-end gap-3">
              ...
              {mensajeEstado && (
                ...
                >
                  ...
                  {tipoMensajeEstado === "error" && <AlertOctagon className="w-4 h-4" />}
