// src/app/(dashboard)/secretaria/configuracion/temas/page.tsx
"use client";
...
export default function ConfiguracionTemasSecretariaPage() {
  ...
  >("temas"); // <- pestaña TEMAS activa por defecto
  ...
  // SOLO USAREMOS LA PESTAÑA "TEMAS" EN ESTA PÁGINA
  // ========================================
  ...
  const renderContenidoTab = () => {
    ...
    // En esta ruta sólo debería verse "temas"
    return null;
  };
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              >
                Personaliza el tema y la apariencia sin afectar la configuración global del
                establecimiento.
              </p>
            </div>
            ...
            {[
              {
                ...
                label: "General",
                icono: Settings,
                ruta: "/secretaria/configuracion",
              },
              {
                id: "notificaciones",
                label: "Notificaciones",
                icono: Bell,
                ruta: "/secretaria/configuracion/notificaciones",
              },
              {
                id: "seguridad",
                label: "Seguridad",
                icono: Shield,
                ruta: "/secretaria/configuracion/seguridad",
              },
              {
                id: "temas",
                label: "Temas",
                icono: Sparkles,
                ruta: "/secretaria/configuracion/temas",
              },
              {
                id: "integraciones",
                label: "Integraciones",
                icono: PlugIcon,
                ruta: "/secretaria/configuracion/integraciones",
              },
              {
                id: "accesibilidad",
                label: "Accesibilidad",
                icono: Eye,
                ruta: "/secretaria/configuracion/accesibilidad",
              },
            ].map((tab) => {
              const activo = tabActiva === tab.id;
              const Icono = tab.icono as React.ComponentType<any>;
              return (
                <button
                  key={tab.id}
                  type="button"
