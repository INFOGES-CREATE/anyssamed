// src/app/(dashboard)/secretaria/recordatorios/programados/page.tsx
"use client";
...
export default function RecordatoriosProgramadosSecretariaPage() {
  // Sesión / usuario
  ...
  const cancelarRecordatorio = async (idRecordatorio: number) => {
    try {
      setCancelandoId(idRecordatorio);
      ...
      const response = await fetch(
        `/api/secretaria/recordatorios/${idRecordatorio}/cancelar`,
        {
          ...
          credentials: "include",
          body: JSON.stringify({
            motivo: "Cancelado desde panel de recordatorios programados",
          }),
        }
      );
  ...
  const recordatoriosFiltrados = useMemo(() => {
    ...
    return recordatoriosProgramados.filter((r) => {
      // Solo vista de programados / pendientes (lo que interesa aquí)
      if (
        filtroEstado === "programados" &&
        !["pendiente", "programado"].includes(r.estado)
      ) {
        return false;
      }

      if (filtroEstado !== "todos" && filtroEstado !== "programados") {
        if (r.estado !== filtroEstado) return false;
      }
      ...
      // Solo mostrar los que no están cancelados
  ...
  const historialOrdenado = useMemo(
    () =>
      [...recordatoriosProgramados].sort((a, b) => {
        const fa =
      ...
      >
        <div className="text-center">
          ...
          <h2 className={`text-4xl font-black mb-4 ${tema.colores.texto}`}>
            Cargando recordatorios programados
          </h2>
          <p
            className={`text-lg font-semibold ${tema.colores.textoSecundario} animate-pulse`}
          >
            Preparando la vista de recordatorios para tus pacientes...
          </p>
        </div>
      </div>
    );
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-4">
            <div>
              ...
              >
                Vista dedicada a los recordatorios programados para tus pacientes.
              </p>
              <p
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      >
                        Vista detallada de todos los recordatorios activos.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    >
                      ...
                      <option value="programados">Programados / pendientes</option>
                        ...
                        <div className="flex flex-col items-end gap-1">
                          {r.estado !== "enviado" &&
                            r.estado !== "cancelado" && (
                              <button
                                ...
                                disabled={enviandoId === r.id_recordatorio}
                          ...
                          {r.estado !== "cancelado" && (
                            <button
                              ...
                              disabled={cancelandoId === r.id_recordatorio}
                              className={`px-3 py-1 bg-red-600/80 hover:bg-red-700 text-white rounded-lg text-[10px] font-bold flex items-center gap-1 transition-all duration-200 ${
                                cancelandoId === r.id_recordatorio
                                  ? "opacity-70 cursor-not-allowed"
                                  : ""
                              }`}
                            >
                  ...
                  {recordatoriosHoyOrdenados.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p
                        className={`text-sm ${tema.colores.textoSecundario}`}
                      >
                        Programa recordatorios desde el panel general o desde la
                        agenda.
                      </p>
                    </div>
                  ) : (
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <p
                className={`text-sm font-semibold ${tema.colores.textoSecundario}`}
              >
                © 2025 AnyssaMed. Recordatorios Programados.
              </p>
              <span
