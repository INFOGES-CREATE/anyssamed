...
export async function POST(
  ...
  try {
    ...
    // =========================================================================
// =========================================================================
// 7. ENVIAR CORREO CON LINK DE RECUPERACIÓN
// =========================================================================

const resetUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/auth/reset-password?token=${nuevoToken}`;

await sendMail({
  to: usuarioAntes.email,
  subject: "🔐 Restablecimiento de contraseña - ANYSSA MED",
  html: `
    <div style="font-family:Arial, sans-serif; line-height:1.6;">
      <h2>Hola ${usuarioAntes.nombre},</h2>
      ...
      <p><strong>⚠️ Este enlace es válido por ${RESET_TOKEN_VALID_MINUTES} minutos.</strong></p>

      <p>Si no solicitaste este cambio, puedes ignorar este mensaje.</p>

      <br/>
      <p>Saludos,</p>
      <p><strong>Equipo ANYSSA MED</strong></p>
    </div>
  `,
});
...
return NextResponse.json({
  success: true,
  message: "Token generado y correo enviado",
  data: {
