...
```ts
import { useCreateUser, useGetDoctor, useUpdateAppointmentNotes, useListServices } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateUser();

const { data, isPending, isSuccess, isError, error } = useGetDoctor();
...
```js
import { createUser, getDoctor, updateAppointmentNotes, listServices } from '@dataconnect/generated';
