const { createUserRef, getDoctorRef, updateAppointmentNotesRef, listServicesRef, connectorConfig } = require('../index.cjs.js');
...
exports.useGetDoctor = function useGetDoctor(dcOrOptions, options) {
